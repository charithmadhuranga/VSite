          ...
          {filtered.map((post) => (
            <div key={post.id} className="flex items-center gap-4 rounded-xl border border-white/5 bg-white/[0.02] px-5 py-4">
              <div className="min-w-0 flex-1">
                <Link to={`/blog/admin/posts/${post.id}/edit`} className="text-sm font-medium text-white hover:text-primary transition-colors truncate block">
                  {post.title}
                </Link>
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <Link to={`/blog/admin/posts/${post.id}/edit`} className="p-2 rounded-lg text-white/40 hover:text-primary hover:bg-white/5 transition-colors">
